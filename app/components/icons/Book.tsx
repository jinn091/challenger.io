  ...
  return (
    ...
    >
      <g>
        ...
        <path d="M47.5,24.3l17.8,12.2c0.3,0.2,0.6,0.3,0.8,0.3c0.5,0,0.9-0.2,1.2-0.7c0.5-0.7,0.3-1.6-0.4-2.1L49.2,21.8   c-0.7-0.5-1.6-0.3-2.1,0.4C46.6,22.9,46.8,23.8,47.5,24.3z" />
      </g>
    </svg>
  );
}
